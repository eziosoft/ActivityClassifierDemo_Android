...
private const val TAG = "LoadNormalizationParamsUseCase"
 ...
 */
@Singleton
class LoadNormalizationParamsUseCase @Inject constructor(
    @param:ApplicationContext private val context: Context
) {
    suspend operator fun invoke(): NormalizationData? = withContext(Dispatchers.IO) {
